...
public class ApplicationController {
    ...
    //所有服务和其相关信息
    @RequestMapping(value = "/getAllAPPAndRelation", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/getSuccessByConsumer", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public
    @ResponseBody
...
//                Integer consumerSum = consumerMap.get(providerName);
    ...
    // 按时间
    @RequestMapping(value = "/getSuccessByConsumerOnHour", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public
    @ResponseBody
    ...
    // 按日期:15天
    @RequestMapping(value = "/getSuccessByConsumerOnDay", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public
    @ResponseBody
    ...
    // 获得
    @RequestMapping(value = "/getMethodRanking", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public
    @ResponseBody
